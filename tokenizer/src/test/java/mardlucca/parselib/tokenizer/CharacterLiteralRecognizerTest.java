/*
 * File: CharacterLiteralRecognizerTest.java
 *
...
public class CharacterLiteralRecognizerTest
{
    ...
    public void testFailureCases()
    {
        ...
        test("'aa'", MatchResult.PARTIAL_MATCH, MatchResult.PARTIAL_MATCH,
    ...
    {
        testError("aa", null);
        testError("''", "Empty character literal is not valid");
        testError("'ba",
            "Only one character must be specified in a character literal");
        testError("'\n", "Unterminated character literal");
        testError("'a\n", "Unterminated character literal");
        testError("'\uffff", "Unterminated character literal");
